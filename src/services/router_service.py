...
class RouterService:
    ...
    def __init__(self, algorithm_name, model_ids, algorithm_params=None, context_dimension=10):
        self.algorithm_name = algorithm_name
        self.model_ids = model_ids
        self.algorithm_params = algorithm_params or {}
        self.bandit = self._create_bandit(algorithm_name, model_ids, context_dimension=context_dimension)
    ...
    def _create_bandit(self, algorithm_name, model_ids, context_dimension):
        ...
        try:
            ...
            return bandit_class(model_ids, **self.algorithm_params, context_dimension=context_dimension)
